...
export default {
  ...
  methods: {
    ...
    //? Get room by id
    async getRoom() {
      let room = await http.get(`room/show/update/${this.id}`);
      if (room) {
        let data = room.data.data;
        this.roomId = data.room_id;
        this.roomNameTh = data.room_name_th;
        this.roomNameEn = data.room_name_en;
        this.roomType = data.type_room_id;
        this.floor = data.floor;
        this.building = data.building_id;
        this.careTaker = data.personnel_id;
        this.amountSeat = data.amount_seat;
